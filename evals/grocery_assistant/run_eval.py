"""Run evaluations against the deployed Grocery Assistant on Agent Engine.
...
Requires:
    - google-genai >= 1.63.0
    - Deployed grocery assistant agent on Agent Engine
...
GCS_DEST = "gs://wortz-project-352116-ge-workshop/evals/grocery_assistant"
AGENT_ENGINE_ID = "3727910666648944640"
...
def run_evaluation():
    """Run inference + evaluation against the deployed grocery assistant."""
    print("=" * 80)
    print("RUNNING GROCERY ASSISTANT EVALUATION (Agent Engine API)")
    print("=" * 80)
    ...
    evaluation_run = client.evals.create_evaluation_run(
        ...
        metrics=metrics,
        dest=GCS_DEST,
        display_name="Grocery Assistant Eval",
